const translations = {
    ...
    sections: {
      ...
      about: {
        ...
        'questions.3.answer': 'Trabajo en Ubisoft, una empresa francesa que crea videojuegos. Principalmente trabajo para la tienda online y la app Ubisoft Connect (PC).',
        'questions.4.question': '¿Y qué haces exactamente?',
        'questions.4.answer': 'Creo componentes reutilizables y microaplicaciones. El objetivo es ofrecer una mejor experiencia unificada a los usuarios en diferentes plataformas (PC y web).',
        'questions.5.question':
          '¿Qué tecnologias usas en tu trabajo profesional?',
        'questions.5.answer': 'Trabajo con React y Typescript. Desarrollo micro frontends en arquitectura monorepo (con Turborepo y Vite). También tengo fuertes habilidades en styling (Sass) y trabajo un poco con SFCC (Salesforce Commerce Cloud) y pruebas unitarias (con Jest).',
        chatbot: {
          placeholder: 'Escribe tu pregunta...',
          fallbackAnswer: 'No he entendido o no puedo responder a la pregunta. Por favor, reformúlala e inténtalo de nuevo.',
          ask: 'Preguntar',
          provideQuestion: 'Debes escribir una pregunta.',
          errorOccurred: 'Ocurrió un error, por favor inténtalo de nuevo más tarde.',
          errorRecaptcha:
            'Algo ha ido mal con la verificación anti-bot. Por favor, inténtalo de nuevo o actualiza la página.',
          disclaimer: 'No tengo todas las respuestas y solo puedo responder una pregunta a la vez. La primera solicitud puede tardar un poco más en procesarse. Por favor sé respetuoso.',
          errors: {
